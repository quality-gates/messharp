...
Each exploratory testing pass drives the CLI through realistic user journeys. The fixtures, outputs and filed issues are kept next to each report so the findings can be replayed.
