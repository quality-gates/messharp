...
public static class Cli
{
    ...
    private static MessCS.Report.Report? RunAnalysis(CliOptions opts, List<RuleSetType> sets, TextWriter stderr)
    {
        try
        {
            return MessCS.Runner.Runner.Run(new RunOptions
            {
    ...
    private static bool WriteReport(CliOptions opts, MessCS.Report.Report report,
